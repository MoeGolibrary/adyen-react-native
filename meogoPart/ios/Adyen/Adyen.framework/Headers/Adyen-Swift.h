...
#ifndef ADYEN_SWIFT_H
#define ADYEN_SWIFT_H
...
/// <code>ADYViewController</code> serves as a height-aware <code>UIViewController</code>
SWIFT_CLASS("_TtC5Adyen17ADYViewController")
...
@interface ADYFormViewController : UIViewController
- (void)viewDidLoad;
...
/// A <code>FormViewController</code> with a <code>FormAddressItem</code> and optional <code>FormSearchButtonItem</code>
SWIFT_CLASS("_TtC5Adyen30AddressInputFormViewController")
@interface AddressInputFormViewController : ADYFormViewController
- (void)viewDidLoad;
@end
...
SWIFT_CLASS("_TtC5Adyen27AddressLookupViewController")
@interface AddressLookupViewController : UINavigationController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5Adyen16AnimationContext")
@interface AnimationContext : NSObject
...
SWIFT_CLASS("_TtC5Adyen17ApplePayComponent")
...
@interface ApplePayComponent (SWIFT_EXTENSION(Adyen)) <PKPaymentAuthorizationViewControllerDelegate>
...
SWIFT_CLASS("_TtC5Adyen12ModalToolbar")
@interface ModalToolbar : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC5Adyen17CancellingToolBar")
@interface CancellingToolBar : ModalToolbar
@end


SWIFT_CLASS("_TtC5Adyen18CardViewController")
@interface CardViewController : ADYFormViewController
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
@end
...
/// :nodoc:
SWIFT_CLASS("_TtC5Adyen13ContainerView")
...
SWIFT_CLASS("_TtC5Adyen13CopyLabelView")
...
/// seealso:
///
/// <a href="https://docs.adyen.com/online-payments/ios/drop-in">Implementation Reference</a>
SWIFT_CLASS("_TtC5Adyen15DropInComponent")
@interface DropInComponent : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Displays a form for the user to enter details.
SWIFT_CLASS("_TtC5Adyen8FormView")
...
SWIFT_CLASS("_TtC5Adyen24KeyFrameAnimationContext")
@interface KeyFrameAnimationContext : AnimationContext
@end

@class NSTextContainer;

/// A text view that easily makes links - delimited with a <code>linkRangeDelimiter</code> - selectable
/// Use <code>update(text:style:linkRangeDelimiter:)</code> to update the content
SWIFT_CLASS("_TtC5Adyen12LinkTextView")
...
@interface LinkTextView (SWIFT_EXTENSION(Adyen)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC5Adyen8ListCell")
...
SWIFT_CLASS("_TtC5Adyen12ListItemView")
...
SWIFT_CLASS("_TtC5Adyen18ListViewController")
...
SWIFT_CLASS("_TtC5Adyen11LoadingView")
...
/// A view controller that shows search results in a <code>ListViewController</code>
SWIFT_CLASS("_TtC5Adyen20SearchViewController")
...
@interface SearchViewController (SWIFT_EXTENSION(Adyen)) <UISearchBarDelegate>
- (void)searchBar:(UISearchBar * _Nonnull)searchBar textDidChange:(NSString * _Nonnull)searchText;
- (void)searchBarSearchButtonClicked:(UISearchBar * _Nonnull)searchBar;
@end


SWIFT_CLASS("_TtC5Adyen22SpringAnimationContext")
@interface SpringAnimationContext : AnimationContext
@end


/// A rounded submit button used to submit details.
SWIFT_CLASS("_TtC5Adyen12SubmitButton")
...
SWIFT_CLASS_NAMED("TextField")
@interface AdyTextField : UITextField
